...
> **Version** : v3.15.0 (crypto-only, hard-fork v9 « la récompense se partage ») | **Stack** : Rust (Tauri 2.0) + Svelte 5 | **Coin** : QUANTA
> **Licence** : Apache-2.0
...
```
508 tests lib + 1 intégration, 0 failures
