...
> **Version** : v3.15.1 (crypto-only, hard-fork v9 « la récompense se partage ») | **Stack** : Rust (Tauri 2.0) + Svelte 5 | **Coin** : QUANTA
> **Licence** : Apache-2.0
