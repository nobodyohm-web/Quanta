...
> **Version** : v3.14.0 (crypto-only, hard-fork v8 « la monnaie exacte, la porte ouverte ») | **Stack** : Rust (Tauri 2.0) + Svelte 5 | **Coin** : QUANTA
> **Licence** : Apache-2.0
...
```
502 tests lib + 1 intégration, 0 failures
